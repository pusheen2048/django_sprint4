...
urlpatterns = [
    ...
    path('edit_profile/<str:username/', views.ProfileUpdateView.as_view(), name='edit_profile'),
    path('profile/<str:username>/change_password/', views.ChangePasswordView.as_view(), name='change_password'),
    ...
    path('posts/<int:post_id>/add_comment/', views.CommentCreateView.as_view(), name='add_comment'),
